...
* 1.2.1 - Changed the way the register_default callback is registered for better debugging. Also callbacks before this change weren't registering properly. Now they work.
